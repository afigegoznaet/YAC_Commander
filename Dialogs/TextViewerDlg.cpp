...
DataStorageArray::DataStorageArray(const QByteArray &arr) { m_data = arr; }
...
unsigned long long DataStorageArray::size() { return m_data.count(); }
...
unsigned long long DataStorageFile::size() { return m_file.size(); }
